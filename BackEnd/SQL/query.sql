...
--total query
SELECT ci.tcb_card_no "TCB Card NO.",ci.area_code "Area CODE",ci.package_no "Package",ci.name "Name",ci.gender "Sex" ,ci.age "Age",ce.totalspent "Total Spending Money",g.item_name"Items"
    di.dealer_id "Dealer ID" ,di.applicant_name "Dealer Name"
